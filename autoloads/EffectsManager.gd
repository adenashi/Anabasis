...
## [br] 1: Attack[br] 2: Defense[br] 3: Combo[br] 4: Active [br] 5: Rolling [br] 6: Buffing[br] 7: Healing[br] 8: Cooldown[br] 9: Locked
@export var StatusIcons : Dictionary = {
	...
	BaseCard.StatusEffect.BUFFING:[],
	BaseCard.StatusEffect.HEALING:[],
	BaseCard.StatusEffect.COOLDOWN:[],
	BaseCard.StatusEffect.LOCKED:[],
}

## Particle prefabs used by [FieldManager] when showing attacks.
...
## Particle prefabs used by [FieldManager] when showing impacts.
@export var Impacts : Dictionary[String, PackedScene] ={
	"Star": preload("res://assets/effects/star_particle_2.tscn"),
}

## Particle prefabs used by [FieldManager] when showing added defense.
